# Agenda Worship (Angular + Tailwind)

Proyecto Angular desde cero con **Tailwind CSS v4** para la gestión del equipo de alabanza.

- **Estilos:** Tailwind CSS (utilidades en el HTML). Ver `TAILWIND-GUIA.md` para aprender a usarlo.
- **Backend:** API en Spring Boot (proyecto `Worship` en la raíz del repo).
